...
class OnCartCreateSaveRepositoryTest {

    @Mock
    private CartRepositoryPort cartRepositoryPort;

    private OnCartCreateSaveRepository handler;

    @BeforeEach
    void setUp() {
        handler = new OnCartCreateSaveRepository(cartRepositoryPort);
    }

    @Test
    void execute_shouldSaveCart_GreenPath() {
        // Given
        ...
        // Then
        verify(cartRepositoryPort).save(cart);
    }
